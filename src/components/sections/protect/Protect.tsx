					...
					<ul className={style.protect__list}>
							<li>
								<div className={style.protect__title}>
									<img src="/img/icons/protect1.svg"  className="item__icon" />
							...
							<li>
								<div className={style.protect__title}>
									<img src="/img/icons/protect2.svg"  className="item__icon" />
							...
							<li>
								<div className={style.protect__title}>
									<img src="/img/icons/protect3.svg"  className="item__icon" />
							...
							<li>
								<div className={style.protect__title}>
									<img src="/img/icons/protect4.svg"  className="item__icon" />
