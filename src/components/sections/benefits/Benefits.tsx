	...
	return <section className={style.benefits}>
		...
		<div className={style.benefits__content}>
			...
			<ul className={style.benefits__list}>
						<li>
							<h3><img src="/img/icons/benefits1.svg" className='item__icon' />Competitive Compensation</h3>
						...
						<li>
							<h3><img src="/img/icons/benefits2.svg" className='item__icon' />Health and Wellness</h3>
						...
						<li>
							<h3><img src="/img/icons/benefits3.svg" className='item__icon' />Retirement Planning</h3>
						...
						<li>
							<h3><img src="/img/icons/benefits4.svg" className='item__icon' />Work-Life Balance</h3>
